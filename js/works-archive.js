...
const WORKS_ARCHIVE = [
  {
      ...
      month: 3,
      day: 20,
      desc: "あなたの知らない姫路を巡る旅へ",
      hue: 20,
      image: "姫路なぞ解きクロスロード.jpg",
      place: "姫路・山陽電車沿線",
      tagline: "あなたの知らない姫路を巡る旅へ",
      story: [
    ...
    },
  {
      ...
      month: 7,
      day: 19,
      desc: "サケけられないたたかいがここにある。",
      hue: 120,
      image: "トキシラズKV.jpg",
      tagline: "サケけられないたたかいがここにある。",
      story: [
        "「ようやくここまで帰ってきた。」",
        "最後の気力を振り絞り、目的地にたどり着け。"
      ],
      overview: {
        team: "最大4人",
        duration: "—",
  ...
  {
      id: "nazokaruta-ex",
      title: "ナゾカルタ EXPERT EDITION",
      hashtag: "#ナゾカルタEX",
      category: "イベント",
      year: 2025,
      month: 5,
      day: 31,
      desc: "とってもたのしいナゾめくカルタ。",
      hue: 90,
      image: "ナゾカルタEXKV（大阪.jpg",
      tagline: "とってもたのしいナゾめくカルタ。",
      story: [
        "とってもたのしいナゾめくカルタ。",
        "EXPERT EDITIONにて新作解禁。",
        "最速タイムを目指して札を取れ！",
    ...
    },
  {
      ...
      tagline: "只今撮影中！",
      story: [
        "カンフー映画撮影会の手伝いにやってきたあなた。",
        "早速、撮影をはじめようとしたが……",
        "この監督、適当すぎる！！？！",
        "無理難題をひらめきで解決し、クランクアップを目指そう！"
      ],
      overview: {
        team: "最大4人",
        duration: "—",
    ...
    },
  {
      ...
      month: 11,
      day: 11,
      desc: "パネルを駆使して全ての謎を解け！",
      hue: 180,
      image: "あっちそっちたっち.jpg",
      place: "東京タワー（謎解きフェスタ）",
      tagline: "パネルを駆使して全ての謎を解け！",
      story: [
        "あなたが入った部屋には75枚のパネル。",
